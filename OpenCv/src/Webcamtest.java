...
public class Webcamtest
{
 ...
 public static Mat analyze(Mat image){	   
	   System.loadLibrary("opencv_java248");
//		Mat image = Highgui.imread("C:/Users/Study/Desktop/symbols.jpg", Imgproc.COLOR_BGR2GRAY);
//	   	Mat Emptyimage = Highgui.imread("C:/Users/Study/Desktop/empty.png", Imgproc.COLOR_BGR2GRAY);
	    ...
	    Imgproc.drawContours(imageHSV, contoursToDraw, -1, new Scalar(50,50,50));
